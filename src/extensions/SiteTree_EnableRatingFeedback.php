...
class SiteTree_EnableRatingFeedback extends DataExtension
{
    ...
    private static $casting = [
        'RatingBlockIntro' => 'DBHTMLText',
        'RatingBlockSuccess' => 'DBHTMLText'
    ];
    ...
    */
    ...
    {
        return ($this->owner->RatingBlockIntro) ? $this->owner->dbObject('RatingBlockIntro') : SiteConfig::current_site_config()->dbObject('DefaultRatingBlockIntro');
    }

    public function getBlockSuccess()
    {
        return ($this->owner->RatingBlockSuccess) ? $this->owner->dbObject('RatingBlockSuccess') : SiteConfig::current_site_config()->dbObject('DefaultRatingBlockSuccess');
    }
